 ...
 * Site controller
 */
class IkUzBotController extends Controller
{
            ...
            if ($step == 2) {
                if (json_encode($telegram->input->message->contact) != "null") {
                    ...
                    if ($phoneKod != 998) {
                        return $telegram->sendMessage([
                            'chat_id' => $telegram_id,
                            'text' => "⁉️⛔️ *Arizani faqat UZB telefon raqamlari berishi mumkin\\. Aloqa uchun\\: 992328020*",
                            'parse_mode' => 'MarkdownV2',
    ...
    public static function result($userOne)
    {
        ...
        $admin = "\n\n📌 _Arizangiz ko\\'rib chiqilib tez orada siz bilan 👩‍💻 operatorlarimiz bog\\'lanishadi\\. Aloqa uchun\\: 992328020_";
