...
if ($student->edu_type_id == 1) {
    ...
    if ($exam->contract_type == 1) {
        $con = Yii::t("app" , "a113");
    } elseif ($exam->contract_type > 1) {
        $con = Yii::t("app" , "a118");
    } elseif ($exam->contract_type < 1) {
        $con = Yii::t("app" , "a117");
    }
            ...
            <div class="iik_box btop">
                <div class="iik_box_item">
                    <div class="down_title">
                        <h6><i class="fa-solid fa-wand-magic-sparkles"></i> &nbsp;&nbsp; <?= $con ?></h6>
                    </div>
        ...
        <?php if ($student->exam_type == 0) : ?>
            <?php if ($exam->status < 3) : ?>
                <div class="d-flex justify-content-center top30">
                    <a href="<?= Url::to(['cabinet/test']) ?>" class="step_right_btn step_btn">
