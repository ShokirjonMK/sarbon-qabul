...
$(document).ready(function() {
        $(".check-exam-form #examsubject-file_status").on('change', function () {
            var id = $(this).val();
            var text2 = 'Tabriklaymiz! Sizning “SARBON UNIVERSITETI”ga topshirgan  sertifikatingiz tasdiqlandi va sizga fan blokidan maksimal ball berildi. To\'lov shartnomasini yuklab olishni unutmang. Shartnomangizni https://qabul.sarbon.university sayti orqali yuklab oling. Aloqa markazi: 78 888 22 88';
            var text3 = 'Hurmatli abituriyent! Sizning “SARBON UNIVERSITETI”ga topshirgan  sertifikatingiz rad etildi. Online test topshirib to\'lov shartnomasini yuklab olishni unutmang. Shartnomangizni https://qabul.sarbon.university sayti orqali yuklab oling. Aloqa markazi: 78 888 22 88';
            if (id == 3) {
