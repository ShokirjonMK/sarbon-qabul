...
<table width="100%" style="font-family: 'Times New Roman'; font-size: 12px; border-collapse: collapse;">
    ...
    <tr>
        <td colspan="4">
            <b>SARBON UNIVERSITY”</b> oliy ta’lim tashkiloti (keyingi o‘rinlarda “Universitet”) nomidan Ustav asosida ish yurituvchi direktor <b>SHARIPOV MUZAFFAR TOLIBJONOVICH</b> birinchi tomondan,
            <table width="100%">
                <tr>
    ...
    <tr>
        <td colspan="4">
            <?= $joy ?> 1.1. Mazkur shartnomaga muvofiq Universitet Talabani quyida ko‘rsatilgan ta’lim yo‘nalishi va ta’lim shakli bo‘yicha oliy ta’limning davlat ta’lim standartlari asosida tasdiqlangan o‘quv reja va o‘quv dasturlari asosida o‘qitish, Buyurtmachi esa Talabaning Universitet tomonidan belgilangan tartib-qoidalarga rioya qilgan holda ta’lim olganligi uchun haq to‘lash majburiyatini oladi.
        </td>
    </tr>
        ...
        <td colspan="4">
            <div>
                <table width="100%">
                    ...
                    <tr>
                        <td colspan="2" style="vertical-align: top;">
                            <b>Buyurtmachi:</b><br><br>
                            <b>Yuridik shaxs:</b> _________________ ________________ <br><br>
                            _____________ _________________ _____________________ <br><br>
                            <b>Manzil: </b> _________________ ________________ <br><br>
                            _____________ _________________ _____________________ <br><br>
                            <b>H/r:</b> _________________ ________________ <br><br>
                            <b>Bank:</b> _________________ ________________ <br><br>
                            <b>MFO:</b> _________________ ________________ <br><br>
                            <b>STIR:</b> _________________ ________________ <br><br>
                            <b>Tel:</b> _________________ ________________ <br><br>
                            <b>E-mail:</b> _________________ ________________ <br><br>
                            <br>
                            <b>Rahbar:</b> ____________ ______________ _________
                        </td>
                    </tr>
                </table>
            </div>
                    ...
                    <td colspan="4">
                        ...
                        <table width="100%" style="border-collapse: collapse; border: 1px solid;">
                            <tr>
                                ...
                                <td colspan="2" style="padding: 5px; border: 1px solid;"><b>SARBON UNIVERSITY” MCHJ</b></td>
                            </tr>
